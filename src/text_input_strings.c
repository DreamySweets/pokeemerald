...
const u8 gText_NamingScreenKeyboard_abcdef[] = _("{CLEAR 11}q{CLEAR 6}w{CLEAR 6}e{CLEAR 6}r{CLEAR 6}t{CLEAR 6}y{CLEAR 6}u{CLEAR 6}i{CLEAR 6}o{CLEAR 6}p{CLEAR 6}à{CLEAR 6}á");
const u8 gText_NamingScreenKeyboard_ghijkl[] = _("{CLEAR 11}a{CLEAR 6}s{CLEAR 6}d{CLEAR 6}f{CLEAR 6}g{CLEAR 6}h{CLEAR 6}j {CLEAR 6}k{CLEAR 6}l");
const u8 gText_NamingScreenKeyboard_mnopqrs[] = _("{CLEAR 11}z{CLEAR 6}x{CLEAR 6}c{CLEAR 6}v{CLEAR 6}b{CLEAR 6}n{CLEAR 6}m{CLEAR 27} ");
...
const u8 gText_NamingScreenKeyboard_ABCDEF[] = _("{CLEAR 11}Q{CLEAR 6}W{CLEAR 6}E{CLEAR 6}R{CLEAR 6}T{CLEAR 6}Y{CLEAR 6}U{CLEAR 6}I{CLEAR 6}O{CLEAR 6}P");
const u8 gText_NamingScreenKeyboard_GHIJKL[] = _("{CLEAR 11}A{CLEAR 6}S{CLEAR 6}D{CLEAR 6}F{CLEAR 6}G{CLEAR 6}H{CLEAR 6}J {CLEAR 6}K{CLEAR 6}L");
const u8 gText_NamingScreenKeyboard_MNOPQRS[] = _("{CLEAR 11}Z{CLEAR 6}X{CLEAR 6}C{CLEAR 6}V{CLEAR 6}B{CLEAR 6}N{CLEAR 6}M{CLEAR 27} ");
const u8 gText_NamingScreenKeyboard_TUVWXYZ[] = _("{CLEAR 11}T{CLEAR 6}U{CLEAR 6}V{CLEAR 26}W{CLEAR 6}X{CLEAR 6}Y{CLEAR 6}Z{CLEAR 26} ");
