...
static const u32 sCFuto_Palette[] = INCBIN_U32("graphics/battle_transitions/cfuto.gbapal");
static const u32 sFuto_Palette[] = INCBIN_U32("graphics/battle_transitions/futo.gbapal");
static const u32 sTojiko_Palette[] = INCBIN_U32("graphics/battle_transitions/tojiko.gbapal");
...
static bool8 Phase2_CMamizou_Func4(struct Task *task)
{
    ...
    GetBg0TilesDst(&tilemap, &tileset);
    CpuCopy16(sCMamizou_Tilemap, tilemap, 0x1000);
    task->tState++;
    return FALSE;
}
