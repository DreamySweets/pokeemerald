const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_PAY_DAY] = _("Higan's Toll"),
    [MOVE_FIRE_PUNCH] = _("Fire Punch"),
    [MOVE_ICE_PUNCH] = _("Ice Punch"),
    [MOVE_THUNDER_PUNCH] = _("Bolt Punch"),
    ...
    [MOVE_WHIRLWIND] = _("Blow Away"),
    [MOVE_FLY] = _("Fly"),
    [MOVE_BIND] = _("Bind"),
    [MOVE_SLAM] = _("SLAM"),
    [MOVE_VINE_WHIP] = _("Vine Whip"),
    [MOVE_STOMP] = _("Trample"),
    [MOVE_DOUBLE_KICK] = _("Double Kick"),
    [MOVE_MEGA_KICK] = _("MEGA KICK"),
    [MOVE_JUMP_KICK] = _("Dropkick"),
    [MOVE_ROLLING_KICK] = _("Roundhouse"),
    [MOVE_SAND_ATTACK] = _("Distract"),
    [MOVE_HEADBUTT] = _("Headbutt"),
    [MOVE_HORN_ATTACK] = _("HORN THRUST"),
    [MOVE_FURY_ATTACK] = _("RAGING STABS"),
    [MOVE_HORN_DRILL] = _("HORN DRILL"),
    [MOVE_TACKLE] = _("Body Blow"),
    [MOVE_BODY_SLAM] = _("Lean On"),
    [MOVE_WRAP] = _("WRAP"),
