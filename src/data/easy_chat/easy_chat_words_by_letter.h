...
const u16 gEasyChatWordsByLetter_B[] = {
    ...
    EC_MOVE(BITE),
    EC_MOVE2(BLAST_BURN),
    EC_POKEMON2(CLILYBLACK),
    EC_WORD_BLAZE,
    EC_MOVE2(BLAZE_KICK),
    EC_POKEMON(AREIMU),
    EC_WORD_BLEND,
    EC_POKEMON2(SHINGYOKUM),
    EC_MOVE2(BLIZZARD),
    EC_MOVE2(BLOCK),
    EC_WORD_BOARD,
    EC_MOVE2(BODY_SLAM),
...
const u16 gEasyChatWordsByLetter_D[] = {
    ...
    EC_POKEMON2(DAIYOUSEI),
    -1, 2, // Doubled pokemon species name
    EC_POKEMON(CDAIYOUSEI),
    EC_POKEMON2(CDAIYOUSEI),
    EC_WORD_DOES,
    EC_WORD_DOESN_T,
    EC_WORD_DON_T,
    EC_WORD_DONE,
    ...
    EC_POKEMON2(TOYOHIME),
    EC_MOVE2(DRAGON_BREATH),
    EC_POKEMON2(GOLIATH),
    EC_POKEMON2(CTOYOHIME),
    EC_WORD_DREAM,
...
const u16 gEasyChatWordsByLetter_E[] = {
    ...
    EC_WORD_EH_QUES,
    EC_WORD_EHEHE,
    EC_POKEMON2(CREMILIA),
    EC_POKEMON2(SHIKIEIKI),
    EC_WORD_ELECTRIC,
...
const u16 gEasyChatWordsByLetter_G[] = {
    ...
    -1, 2, // Doubled pokemon species name
    EC_POKEMON(MINORIKO),
    EC_POKEMON2(MINORIKO),
    EC_WORD_GOLD,
    -1, 2, // Doubled pokemon species name
    EC_POKEMON(CSTARSAPPHIRE),
    EC_POKEMON2(CSTARSAPPHIRE),
    -1, 2, // Doubled pokemon species name
    EC_POKEMON(YORIHIME),
    EC_POKEMON2(YORIHIME),
    -1, 2, // Doubled pokemon species name
    EC_POKEMON(CKOGASA),
    EC_POKEMON2(CKOGASA),
    EC_WORD_GOOD,
...
const u16 gEasyChatWordsByLetter_K[] = {
    ...
    EC_POKEMON2(CPATCHOULI),
    EC_POKEMON2(SHIZUHA),
    EC_POKEMON2(SUNNYMILK),
    EC_MOVE(KARATE_CHOP),
    EC_POKEMON(SWRIGGLE),
    EC_WORD_KEEN_EYE,
    EC_WORD_KID,
...
const u16 gEasyChatWordsByLetter_N[] = {
    ...
    EC_POKEMON2(YOUMU),
    EC_POKEMON2(FLANDRE),
    EC_POKEMON2(SHANGHAI),
    EC_POKEMON2(HOURAI),
    EC_POKEMON2(CFLANDRE),
    EC_POKEMON2(CYOUMU),
    EC_WORD_NIGHT,
...
const u16 gEasyChatWordsByLetter_P[] = {
    ...
    EC_WORD_PICKUP,
    EC_POKEMON2(KOAKUMA),
    EC_POKEMON2(CKOAKUMA),
    EC_POKEMON2(MEDICINE),
    -1, 2, // Doubled pokemon species name
    EC_POKEMON(CCIRNO),
    EC_POKEMON2(CCIRNO),
    EC_POKEMON2(DYOUMU),
    EC_MOVE2(PIN_MISSILE),
    EC_POKEMON2(DSUNNYMILK),
    -1, 2, // Doubled pokemon species name
    EC_POKEMON(SHOU),
    EC_POKEMON2(SHOU),
    EC_WORD_PKRS,
...
const u16 gEasyChatWordsByLetter_S[] = {
    ...
    EC_POKEMON2(LUNACHILD),
    -1, 2, // Doubled pokemon species name
    EC_POKEMON(STARSAPPHIRE),
    EC_POKEMON2(STARSAPPHIRE),
    ...
    EC_WORD_SPORTS,
    EC_WORD_SPRING,
    EC_POKEMON2(CLILYWHITE),
    EC_WORD_STAGE,
    EC_POKEMON2(TBYAKUREN),
    -1, 2, // Doubled pokemon species name
    EC_POKEMON(YUUKA),
    EC_POKEMON2(YUUKA),
    EC_WORD_START,
...
const u16 gEasyChatWordsByLetter_T[] = {
    ...
    EC_WORD_TALK,
    EC_WORD_TALKING,
    EC_POKEMON2(CSUNNYMILK),
    EC_WORD_TASTY,
    EC_MOVE2(TAUNT),
    EC_POKEMON2(CWRIGGLE),
    EC_WORD_TCH,
    EC_WORD_TEACH,
    EC_WORD_TEACHER,
    EC_WORD_TEACHES,
