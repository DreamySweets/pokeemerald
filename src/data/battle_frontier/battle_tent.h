...
{
    SLATEPORT_TENT_MON_ANUE_1,
    SLATEPORT_TENT_MON_DHINA_1,
    SLATEPORT_TENT_MON_ARIN,
    SLATEPORT_TENT_MON_ANUE_2,
    SLATEPORT_TENT_MON_AFLANDRE,
    SLATEPORT_TENT_MON_THATATE,
    SLATEPORT_TENT_MON_SYORIHIME,
    SLATEPORT_TENT_MON_SWRIGGLE_2,
    SLATEPORT_TENT_MON_DSUWAKO_1,
    SLATEPORT_TENT_MON_DSUWAKO_2,
    SLATEPORT_TENT_MON_SYAMAME,
    -1
};
...
{
    SLATEPORT_TENT_MON_ANUE_1,
    SLATEPORT_TENT_MON_KISUME,
    SLATEPORT_TENT_MON_HKOAKUMA,
    SLATEPORT_TENT_MON_ANUE_2,
    SLATEPORT_TENT_MON_CKONNGARA_1,
    SLATEPORT_TENT_MON_ALILYWHITE,
    SLATEPORT_TENT_MON_SYORIHIME,
    SLATEPORT_TENT_MON_DSUWAKO_1,
    SLATEPORT_TENT_MON_CKONNGARA_2,
    SLATEPORT_TENT_MON_DMINORIKO_2,
...
const u16 gSlateportBattleTentTrainerMons_Kelsie[] = 
{
    ...
    SLATEPORT_TENT_MON_AHINA,
    SLATEPORT_TENT_MON_TSHOU,
    SLATEPORT_TENT_MON_SMARISA,
    SLATEPORT_TENT_MON_AFLANDRE,
    SLATEPORT_TENT_MON_THATATE,
    SLATEPORT_TENT_MON_SWRIGGLE_1,
    SLATEPORT_TENT_MON_TKOGASA_2,
    SLATEPORT_TENT_MON_ASUNNYMILK,
    -1
};
...
const u16 gSlateportBattleTentTrainerMons_Davon[] = 
{
    ...
    SLATEPORT_TENT_MON_DMEILING_2,
    SLATEPORT_TENT_MON_KOTOHIME_1,
    SLATEPORT_TENT_MON_SRIN,
    SLATEPORT_TENT_MON_DMINORIKO_1,
    SLATEPORT_TENT_MON_CKONNGARA_1,
    SLATEPORT_TENT_MON_THATATE,
    SLATEPORT_TENT_MON_CMURASA,
    SLATEPORT_TENT_MON_WRIGGLE,
    SLATEPORT_TENT_MON_SWRIGGLE_2,
    SLATEPORT_TENT_MON_DSUWAKO_2,
...
const u16 gSlateportBattleTentTrainerMons_Glenda[] = 
{
    ...
    SLATEPORT_TENT_MON_HLUNASA_2,
    SLATEPORT_TENT_MON_HKOAKUMA,
    SLATEPORT_TENT_MON_AYUYUKO_1,
    SLATEPORT_TENT_MON_AYUYUKO_2,
    SLATEPORT_TENT_MON_ASHIKIEIKI_1,
    SLATEPORT_TENT_MON_CMERLIN,
    SLATEPORT_TENT_MON_EIRIN,
    SLATEPORT_TENT_MON_SYORIHIME,
    SLATEPORT_TENT_MON_CPATCHOULI,
    SLATEPORT_TENT_MON_TNAZRIN_1,
    SLATEPORT_TENT_MON_TNAZRIN_2,
    SLATEPORT_TENT_MON_ASHIKIEIKI_2,
    -1
};
...
const u16 gSlateportBattleTentTrainerMons_Helena[] = 
{
    ...
    SLATEPORT_TENT_MON_TSATORI_2,
    SLATEPORT_TENT_MON_ADVMEILING,
    SLATEPORT_TENT_MON_SYAMAME,
    -1
};
...
const u16 gSlateportBattleTentTrainerMons_Davion[] = 
{
    SLATEPORT_TENT_MON_HKOAKUMA,
    SLATEPORT_TENT_MON_CMERLIN,
    SLATEPORT_TENT_MON_ADVTEWI_1,
    SLATEPORT_TENT_MON_ADVTEWI_2,
    SLATEPORT_TENT_MON_AMARISA,
    SLATEPORT_TENT_MON_SKOGASA,
    SLATEPORT_TENT_MON_EIRIN,
    SLATEPORT_TENT_MON_SMARISA,
    SLATEPORT_TENT_MON_ALILYWHITE,
    SLATEPORT_TENT_MON_SWRIGGLE_1,
    SLATEPORT_TENT_MON_SWRIGGLE_2,
    SLATEPORT_TENT_MON_DMINORIKO_2,
    SLATEPORT_TENT_MON_CRUMIA,
    SLATEPORT_TENT_MON_YUUGI,
    -1
};
...
{
    SLATEPORT_TENT_MON_HLUNASA_1,
    SLATEPORT_TENT_MON_HRAN,
    SLATEPORT_TENT_MON_SRIN,
    SLATEPORT_TENT_MON_ASHIKIEIKI_1,
    SLATEPORT_TENT_MON_TSHOU,
    SLATEPORT_TENT_MON_MINORIKO_1,
    SLATEPORT_TENT_MON_AFLANDRE,
    SLATEPORT_TENT_MON_CMURASA,
    SLATEPORT_TENT_MON_SWRIGGLE_1,
    SLATEPORT_TENT_MON_SWRIGGLE_2,
    SLATEPORT_TENT_MON_TENMA,
    SLATEPORT_TENT_MON_CRUMIA,
    -1
};
...
const struct BattleFrontierTrainer gSlateportBattleTentTrainers[NUM_BATTLE_TENT_TRAINERS] = 
{
    ...
    [SLATEPORT_TENT_TRAINER_RODOLFO] = {
        ...
        .speechBefore = {EC_WORD_GO, EC_WORD_GET, EC_WORD_A, EC_POKEMON(DHATATE), EC_WORD_FOR, EC_WORD_ME},
        .speechWin = {EC_WORD_AWW, EC_WORD_YOU, EC_WORD_DON_T, EC_WORD_HAVE, EC_WORD_A, EC_POKEMON(DHATATE)},
        .speechLose = {EC_WORD_PLEASE, EC_WORD_I, EC_WORD_NEED, EC_WORD_A, EC_POKEMON(DHATATE), EC_WORD_BADLY},
    ...
    [SLATEPORT_TENT_TRAINER_KENDALL] = {
        ...
        .speechLose = {EC_WORD_HOW, EC_WORD_COULD, EC_WORD_YOU, EC_MOVE2(STRIKE), EC_WORD_ME, EC_WORD_QUES},
    ...
    [SLATEPORT_TENT_TRAINER_MAGGIE] = {
        ...
        .speechBefore = {EC_POKEMON(CSUIKA), EC_POKEMON(CHAKUREI), EC_POKEMON2(KURUMI), EC_WORD_ELLIPSIS, EC_WORD_UM, EC_WORD_ELLIPSIS},
        .speechWin = {EC_POKEMON(CELIS), EC_WORD_ELLIPSIS, EC_WORD_UM, EC_POKEMON(TSATORI), EC_WORD_EXCL, -1},
        .speechLose = {EC_POKEMON(CELIS), EC_WORD_ELLIPSIS, EC_WORD_UM, EC_POKEMON2(BYAKUREN), EC_WORD_ELLIPSIS, EC_WORD_UH_OH},
    ...
    [SLATEPORT_TENT_TRAINER_KURTIS] = {
        ...
        .speechWin = {EC_WORD_I, EC_WORD_SAID, EC_WORD_WE, EC_WORD_WOULD, EC_MOVE2(STRIKE), EC_WORD_YOU},
...
const struct FacilityMon gSlateportBattleTentMons[NUM_SLATEPORT_TENT_MONS] = 
{
    ...
    [SLATEPORT_TENT_MON_ADVMEILING] = {
        ...
        .moves = {MOVE_YAWN, MOVE_SLUDGE, MOVE_ENCORE, MOVE_STRIKE},
        .itemTableId = BATTLE_FRONTIER_ITEM_NONE,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,
        .nature = NATURE_IMPISH
    },
...
{
    VERDANTURF_TENT_MON_DSUWAKO,
    VERDANTURF_TENT_MON_ADVMEILING,
    VERDANTURF_TENT_MON_HKOAKUMA,
    VERDANTURF_TENT_MON_AHINA,
    VERDANTURF_TENT_MON_ARIN,
    -1
};
...
const u16 gVerdanturfBattleTentTrainerMons_Dilan[] = 
{
    ...
    VERDANTURF_TENT_MON_DMINORIKO,
    VERDANTURF_TENT_MON_HKOAKUMA,
    VERDANTURF_TENT_MON_SYORIHIME,
    VERDANTURF_TENT_MON_YUUGI,
    -1
};

const u16 gVerdanturfBattleTentTrainerMons_Eliana[] = 
{
    VERDANTURF_TENT_MON_WRIGGLE,
    VERDANTURF_TENT_MON_THATATE,
...
const u16 gVerdanturfBattleTentTrainerMons_Markus[] = 
{
    ...
    VERDANTURF_TENT_MON_THATATE,
    VERDANTURF_TENT_MON_AHINA,
    VERDANTURF_TENT_MON_CSTARSAPPHIRE_2,
    VERDANTURF_TENT_MON_CMURASA,
    -1
};

const u16 gVerdanturfBattleTentTrainerMons_Caitlyn[] = 
{
    VERDANTURF_TENT_MON_DYUYUKO,
    VERDANTURF_TENT_MON_SWRIGGLE,
    VERDANTURF_TENT_MON_ASHIKIEIKI,
    VERDANTURF_TENT_MON_AYUYUKO,
    VERDANTURF_TENT_MON_ATENSHI,
    VERDANTURF_TENT_MON_ANUE,
    -1
};
...
const u16 gVerdanturfBattleTentTrainerMons_Desiree[] = 
{
    ...
    VERDANTURF_TENT_MON_ATENSHI,
    VERDANTURF_TENT_MON_CPATCHOULI,
    -1
};

const u16 gVerdanturfBattleTentTrainerMons_Ronald[] = 
{
    VERDANTURF_TENT_MON_HLUNASA,
    VERDANTURF_TENT_MON_HMERLIN,
    VERDANTURF_TENT_MON_ATOKIKO,
    VERDANTURF_TENT_MON_ASHIKIEIKI,
    VERDANTURF_TENT_MON_CMERLIN,
    -1
};

const u16 gVerdanturfBattleTentTrainerMons_Ashten[] = 
{
    VERDANTURF_TENT_MON_ADVTEWI_1,
    VERDANTURF_TENT_MON_SWRIGGLE,
    VERDANTURF_TENT_MON_ADVTEWI_2,
    VERDANTURF_TENT_MON_DMINORIKO,
    VERDANTURF_TENT_MON_SMARISA,
    -1
};
...
const u16 gVerdanturfBattleTentTrainerMons_Prestin[] = 
{
    ...
    VERDANTURF_TENT_MON_ANUE,
    VERDANTURF_TENT_MON_SMARISA,
    VERDANTURF_TENT_MON_ADVMOKOU,
    -1
};

const u16 gVerdanturfBattleTentTrainerMons_Ernesto[] = 
{
    VERDANTURF_TENT_MON_EIRIN,
    VERDANTURF_TENT_MON_CMERLIN,
    VERDANTURF_TENT_MON_ASHIKIEIKI,
...
const u16 gVerdanturfBattleTentTrainerMons_Darnell[] = 
{
    ...
    VERDANTURF_TENT_MON_AMARISA,
    VERDANTURF_TENT_MON_DMINORIKO,
    VERDANTURF_TENT_MON_ALILYWHITE,
    VERDANTURF_TENT_MON_SMARISA,
    -1
};
...
const u16 gVerdanturfBattleTentTrainerMons_Laila[] = 
{
    VERDANTURF_TENT_MON_CYUUGI,
    VERDANTURF_TENT_MON_AFLANDRE,
    VERDANTURF_TENT_MON_CKONNGARA_2,
    VERDANTURF_TENT_MON_CSTARSAPPHIRE_2,
    VERDANTURF_TENT_MON_ADVMOKOU,
    VERDANTURF_TENT_MON_SMARISA,
    -1
...
{
    FALLARBOR_TENT_MON_ADVMEILING,
    FALLARBOR_TENT_MON_DSUWAKO,
    FALLARBOR_TENT_MON_SENDAI,
    FALLARBOR_TENT_MON_DHINA,
    FALLARBOR_TENT_MON_ARIN,
    FALLARBOR_TENT_MON_ANUE,
    -1
};
...
const u16 gFallarborBattleTentTrainerMons_Javier[] = 
{
    ...
    FALLARBOR_TENT_MON_DMINORIKO,
    FALLARBOR_TENT_MON_HKOAKUMA,
    FALLARBOR_TENT_MON_KISUME,
...
const u16 gFallarborBattleTentTrainerMons_Treve[] = 
{
    ...
    FALLARBOR_TENT_MON_THATATE,
    FALLARBOR_TENT_MON_KOTOHIME,
    FALLARBOR_TENT_MON_CSTARSAPPHIRE_1,
    -1
};

const u16 gFallarborBattleTentTrainerMons_Arianna[] = 
{
    FALLARBOR_TENT_MON_ASHIKIEIKI,
    FALLARBOR_TENT_MON_HMERLIN_2,
    FALLARBOR_TENT_MON_AYUYUKO,
...
{
    FALLARBOR_TENT_MON_ADVTEWI_1,
    FALLARBOR_TENT_MON_ADVTEWI_2,
    FALLARBOR_TENT_MON_SMARISA,
    FALLARBOR_TENT_MON_AMARISA,
    FALLARBOR_TENT_MON_KISUME,
    -1
};
...
const u16 gFallarborBattleTentTrainerMons_Jameson[] = 
{
    ...
    FALLARBOR_TENT_MON_TNAZRIN,
    FALLARBOR_TENT_MON_DYUYUKO,
    FALLARBOR_TENT_MON_WRIGGLE,
    FALLARBOR_TENT_MON_HSHIZUHA,
    -1
};
...
const u16 gFallarborBattleTentTrainerMons_Alanzo[] = 
{
    ...
    FALLARBOR_TENT_MON_TMEDICINE,
    FALLARBOR_TENT_MON_ADVMOKOU,
    FALLARBOR_TENT_MON_YUKI,
    FALLARBOR_TENT_MON_ASUWAKO_1,
    FALLARBOR_TENT_MON_ASUWAKO_2,
    -1
};
...
{
    FALLARBOR_TENT_MON_ASHIKIEIKI,
    FALLARBOR_TENT_MON_EIRIN,
    FALLARBOR_TENT_MON_CMERLIN,
    FALLARBOR_TENT_MON_SMARISA,
    FALLARBOR_TENT_MON_AMARISA,
    -1
};
