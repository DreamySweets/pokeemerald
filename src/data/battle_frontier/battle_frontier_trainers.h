const struct BattleFrontierTrainer gBattleFrontierTrainers[FRONTIER_TRAINERS_COUNT] =
{
    ...
    [FRONTIER_TRAINER_TINA] = {
        ...
        .speechWin = {EC_WORD_HERE_IT_IS, EC_WORD_YOUR, EC_MOVE2(SWEET_KISS), EC_WORD_FROM, EC_WORD_MY, EC_POKEMON2(CSHIKIEIKI)},
    ...
    [FRONTIER_TRAINER_WESLEY] = {
        ...
        .speechBefore = {EC_POKEMON2(AKYUU), EC_POKEMON2(AKYUU), EC_WORD_IS, EC_WORD_HOW, EC_WORD_I, EC_WORD_CRY},
        .speechWin = {EC_WORD_YES, EC_WORD_I, EC_WORD_KNOW, EC_WORD_I_AM, EC_WORD_CUTE, EC_WORD_EXCL},
        .speechLose = {EC_POKEMON2(AKYUU), EC_POKEMON2(AKYUU), EC_WORD_EXCL, EC_POKEMON2(AKYUU), EC_WORD_EXCL_EXCL, 0xFFFF},
    ...
    [FRONTIER_TRAINER_ZACH] = {
        ...
        .speechWin = {EC_WORD_I_AM, EC_WORD_HAPPY, EC_WORD_LIKE, EC_WORD_A_LITTLE, EC_POKEMON2(MARGATROID), EC_WORD_EXCL},
        .speechLose = {EC_WORD_I_AM, EC_WORD_ANGRY, EC_WORD_LIKE, EC_WORD_A, EC_POKEMON2(CKAGUYA), EC_WORD_EXCL},
    ...
    [FRONTIER_TRAINER_GABRIEL] = {
        ...
        .speechBefore = {EC_MOVE2(STRIKE), EC_WORD_THE, EC_WORD_THICK_FAT, EC_WORD_ON, EC_WORD_MY, EC_MOVE2(BELLY_DRUM)},
        .speechWin = {EC_MOVE2(STRIKE), EC_WORD_MY, EC_MOVE2(BELLY_DRUM), EC_MOVE2(STRIKE), EC_WORD_MY, EC_MOVE2(BELLY_DRUM)},
    ...
    [FRONTIER_TRAINER_SOFIA] = {
        .facilityClass = FACILITY_CLASS_AROMA_LADY,
        .trainerName = _("SOFIA"),
        .speechBefore = {EC_POKEMON(AMARISA), EC_WORD_PROBABLY, EC_WORD_HAS, EC_WORD_A, EC_MOVE(SWEET_SCENT), 0xFFFF},
    ...
    [FRONTIER_TRAINER_NIKOLAS] = {
        ...
        .speechWin = {EC_WORD_IF_I_WIN, EC_WORD_I, EC_WORD_PRETEND, EC_WORD_I_AM, EC_WORD_A, EC_POKEMON2(CWRIGGLE)},
        .speechLose = {EC_WORD_IF_I_LOSE, EC_WORD_I, EC_WORD_PRETEND, EC_WORD_I_AM, EC_WORD_A, EC_POKEMON2(SHINGYOKUO)},
    ...
    [FRONTIER_TRAINER_BRODY] = {
        .facilityClass = FACILITY_CLASS_DRAGON_TAMER,
        .trainerName = _("BRODY"),
        .speechBefore = {EC_WORD_MY, EC_WORD_FASHION, EC_WORD_SENSE, EC_WORD_SEEMS, EC_POKEMON(CKEINE), EC_WORD_QUES},
    ...
    [FRONTIER_TRAINER_TESS] = {
        .facilityClass = FACILITY_CLASS_PKMN_BREEDER_F,
        .trainerName = _("TESS"),
        .speechBefore = {EC_WORD_WANT, EC_WORD_SOME, EC_POKEMON(CKIKURI), EC_WORD_DESIGN, EC_WORD_SWEETS, EC_WORD_QUES},
